...
async function fixture(context) {
  ...
  const client = { getConnection: async () => { calls.push("connection"); return connection(); }, disconnectAccount: async (id) => { calls.push(`disconnect:${id}`); await disconnect(id); } };
  ...
  new Function("require", "module", "exports", outputText)((specifier) => {
    ...
    if (specifier === "../../lib/wechat/deviceVault") return { clearDeviceVault: async () => { calls.push("clear-vault"); } };
