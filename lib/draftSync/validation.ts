...
export const DRAFT_LIMITS = {
  xiaohongshu: { label: "小红书", title: 20, body: 1000, images: 18, ratio: 3 / 4, sizeLabel: "3:4（1080 × 1440）" },
  wechat: { label: "公众号贴图", title: 32, body: 1000, images: 20, ratio: 4 / 5, sizeLabel: "4:5（1080 × 1350）" },
} as const;
